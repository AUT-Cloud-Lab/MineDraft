...
plot_group(const_std_group, "./results/fragmentation_data/const-std.png", (10, 6))
plot_group(const_avg_group, "./results/fragmentation_data/const-mean.png", (10, 6))
plot_group(overall_group, "./results/fragmentation_data/overall.png", (18, 8))
